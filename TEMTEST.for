...
C   SUBROUTINE GETTIM
C
C   This is needef ro clean msys2 install ( avoids likning errors " undefined reference to `gettim_'"
C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      SUBROUTINE GETTIM(IHR, IMIN, ISEC, I100)
      INTEGER IHR, IMIN, ISEC, I100
      INTEGER VALUES(8)
